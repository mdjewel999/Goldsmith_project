...
Display the users profile picture in the websits navbar.
          </p>
        </div>
        <div>
          <h1 className="text-3xl font-bold">
...
Implement a user-friendly navigation menu in the websites navbar with links to Home, All Jewelry, My Jewelry, Add Jewelry, Blogs, and the user's profile.
